    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(limit_choices_to={'role': 'supplier'}, on_delete=django.db.models.deletion.CASCADE, related_name='supplied_orders', to=settings.AUTH_USER_MODEL)),
